...
public class FirstTest extends BaseTest{
    ...
    @Test
    @DatabaseSetup(value = "/TestDirector/Setup_director1.xml", type = DatabaseOperation.CLEAN_INSERT)
    @ExpectedDatabase(value = "/TestDirector/Expect_director1.xml",table = "director", assertionMode = DatabaseAssertionMode.NON_STRICT)
    public void Test1() {
        String url = testURL + "/lbc/api/v1/director/uuid123";
        String token = "X-Token:" + getToken("17777777774", "111111");
